...
- **扫码登录**：支持支付宝小程序/微信小程序等扫码方式，Cookie 自动填入并支持复制
- **开机自动启动**：支持后台托盘运行，开机自启
- **隐藏到托盘**：关闭窗口缩小到系统托盘，不退出程序

## 使用

直接运行 `115网盘STRM生成与302工具.exe`，默认弹出原生管理窗口。
关闭窗口缩小到右下角任务栏托盘，右键托盘图标可重新打开或退出。
...
生成 `dist/115网盘STRM生成与302工具.exe`（无控制台窗口）。
