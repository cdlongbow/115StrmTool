...
- **Emby 反向代理**：代理 Emby 请求，拦截 PlaybackInfo 强制 DirectPlay，302 重定向到 115 CDN 直链（流式代理备选），消除 CORS 和 UA 绑定问题
...
播放时代理返回 302 跳转让客户端直连 115 CDN，媒体流量不经过代理服务器。跨域问题通过注入 crossOrigin 拦截脚本解决。
